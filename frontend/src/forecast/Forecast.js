...
const Forecast = () => {
    ...
    React.useEffect( async () => {
        if (calculating) {
            ...
            let url = `http://35.245.223.194:8088/forecast?region=${region}`;
            ...
            axios.get(url).then(resp => {
                ...
                if (!initialized) {
                    setInitialized(true);
                        ...
                        return axios.get(`http://35.245.223.194:8088/avg_features?region=${region}`)
                }else {
                    setCurFeatures({
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={4}>                    
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <img className="forecastGraph" src={ `data:image/png;base64, ${curFeatures.trend_plot}`} />
                        </Grid>
                    </Grid>  
                </Grid> 
                ...
                <Grid item xs={4}>                    
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <img className="forecastGraph" src={ `data:image/png;base64, ${curFeatures.daily_trend}`} />
                        </Grid>
                    </Grid>  
                </Grid>
                <Grid item xs={4}>                    
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <img className="forecastGraph" src={ `data:image/png;base64, ${curFeatures.weekly_trend}`} />
                        </Grid>
                    </Grid>  
                </Grid>               
